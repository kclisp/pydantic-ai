...
1. [Agents](../agent.md) can connect to MCP servers and use their tools through [`MCPToolset`][pydantic_ai.mcp.MCPToolset], built on the [FastMCP](https://gofastmcp.com) client.
2. Some model providers can themselves connect to remote MCP servers using a "built-in tool". [Learn more](../builtin-tools.md#mcp-server-tool) about [`MCPServerTool`][pydantic_ai.builtin_tools.MCPServerTool].
3. Agents can be used within MCP servers. [Learn more](server.md)
